...
class CfgBuildingLoot {
	...
	class HeliCrash: Default {
		...
		lootType[] = {
			...
			{"RH_mk18","weapon",0.04},
			{"RH_mk18dcacog","weapon",0.04},
			{"RH_Mk18acog","weapon",0.04},
			{"RH_mk14ebrgc","weapon",0.04},
			{"R3F_Famas_F1","weapon",0.04},
			{"R3F_Famas_F1_AIM_DES","weapon",0.04},
			{"R3F_Famas_F1_EOT","weapon",0.04},
			{"R3F_Famas_G2","weapon",0.04},
			{"R3F_FRF2_J8","weapon",0.04},
			{"R3F_FRF2_J8_SD_DES","weapon",0.04},
			{"R3F_Minimi_AIM_HG","weapon",0.04},
			{"R3F_HK417M_AIM","weapon",0.04},
			{"R3F_HK417M_AIM_DES","weapon",0.04},
			{"R3F_HK417S_HG_SD","weapon",0.04},
			{"","military",1.00},
			{"","medical",0.5}
		};
	};	
	class HeliCrashWEST: Default {
		...
		lootType[] = {
			...
			{"R3F_HK417M_AIM_DES","weapon",0.04},
			{"R3F_HK417S_HG_SD","weapon",0.04},
			{"R3F_PGM_Hecate_II_DES","weapon",0.04},
			{"R3F_PGM_Hecate_II_POLY","weapon",0.04},
			{"","military",1.00},
			{"","medical",0.5}
		};
	};
